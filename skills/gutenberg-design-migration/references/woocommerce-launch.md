# Stage 8: WooCommerce, data and going live
...
The checklist that applies to every site, shop or not, is in
`references/launch.md`, and so is the hardening that goes with it. Run that
first. The shop adds two items of its own:
